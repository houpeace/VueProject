<template>
    <div>
        <a :href="personalLink" target="_blank" class="outerLink">点击查看完整个性化排序策略</a>
        <el-form ref="form" :inline="true" :model="form" label-width="100px" :rules="rules">
              <el-form-item label="档期" prop="brand">
                <el-input v-model="form.brand" placeholder="输入档期名称/档期ID"></el-input>
              </el-form-item>
              <el-form-item label="用户UID" prop="uid" class="el-form-item-min">
                <el-input v-model="form.uid" placeholder="请输入UID"></el-input>
              </el-form-item>
              <el-form-item label="用户MID" prop="mid">
                <el-input v-model="form.mid" placeholder="请输入MID"></el-input>
              </el-form-item>
              ...
              <el-form-item>
                <el-button type="primary" @click="queryGoods">确定</el-button>
              </el-form-item>
        </el-form>
    </div>
</template>
